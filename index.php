...
<body>
  ...
  <section class="section" id="s-projects">
    ...
    <div class="projects-grid stagger">
      ...
      <!-- Project 1 — SmartKalathi -->
      <a class="project-card"
         href="https://www.smartkalathi.com/"
         target="_blank" rel="noopener">
        <div class="project-num">01 / PROJECT</div>
        <div class="project-icon">🛒</div>
        <div class="project-name">SmartKalathi</div>
        <div class="project-desc">Compares supermarket prices across Cyprus to find where each product is cheapest.</div>
        <div class="project-highlight">478 products · 22 chains · Smart shopping list optimizer</div>
      ...
      <a class="project-card"
        ...
        <div class="project-desc">Batch-validates LEI codes via the GLEIF API and auto-fills Excel files with entity status &amp; renewal dates.</div>
        <div class="project-highlight">100 LEIs processed in the time it takes to look up one — 99% faster.</div>
        <div class="project-tags">
      ...
      <!-- Project 3 — Calendar App Desktop -->
      <a class="project-card"
         href="https://calendar-app-desktop.vercel.app/login"
         target="_blank" rel="noopener">
        <div class="project-num">03 / PROJECT</div>
        <div class="project-icon">📅</div>
        <div class="project-name">Calendar App Desktop</div>
        <div class="project-desc">Offline-first desktop calendar for managing events, reminders, and schedules — no account required.</div>
        <div class="project-tags">
      ...
      <!-- Project 4 — WordPress Portfolio Blog -->
      <a class="project-card"
         href="https://www.thanasis-codes.eu/blog/"
         target="_blank" rel="noopener">
        <div class="project-num">04 / PROJECT</div>
        <div class="project-icon">🌐</div>
        <div class="project-name">WordPress Portfolio Blog</div>
        <div class="project-desc">Portfolio site showcasing UI/UX work, web development projects, and developer articles.</div>
        <div class="project-tags">
    ...
    <div class="contact-modal">
      ...
      <div class="modal-header">
        <div>
          ...
          <h2 class="modal-title" id="modal-heading">Send a <em>message</em></h2>
        </div>
      ...
      <form id="contact-form" class="modal-form" novalidate>
        ...
        <div class="form-group">
          ...
          <input type="text" id="cf-subject" name="subject"
            placeholder="Project inquiry / Collaboration / Question..." required>
        </div>
